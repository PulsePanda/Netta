...
public class Packet implements Serializable {
     ...
     *
     * @param type     PACKET_TYPE. Used to set the function of the packet being
     *                 received.
     * @param senderID String. For Sender Identification
     */
     ...
     *
     * @param packetBytes Byte Array Object that contains the serialized version of the
     *                    packet (Usually the object that was received by the connection
     * @throws IOException            Thrown if the constructor has an issue reading the
     *                                packetBytes
     * @throws ClassNotFoundException Thrown if the constructor has an issue using the Packet class
     *                                (Should never happen)
     */
     ...
     * @throws IOException Thrown if the method has an issue serializing the object
     */
