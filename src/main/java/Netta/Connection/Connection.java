...
public abstract class Connection {
    ...
    private boolean connectionActive = false, encrypted = false;
     ...
     * thrown
     *
     * @throws ConnectionInitializationException if there is an error creating client input and/or output
     *                                           streams
     */
     ...
     *
     * @throws ConnectionException if there is an issue closing the connection streams or
...
//        Thread.currentThread().interrupt();
     ...
     * active.
     *
     * @param p packet being sent to the socket connection
     * @return boolean value based on the success of the send. True if object
     * sent successfully, else false.
     * @throws SendPacketException thrown when there is an error creating or sending a packet to
     ...
     * @throws ReadPacketException thrown when there is an error reading a packet from the
