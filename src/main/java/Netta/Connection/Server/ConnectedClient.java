...
public class ConnectedClient extends Connection implements Runnable {
     ...
     *
     * @param socket connection received by the server.
     * @param kript  object being used by the server. Either create a new one per
     *               connection, or have the same for all connections.
     * @throws ConnectionInitializationException thrown if there is an error initializing the client. Details
